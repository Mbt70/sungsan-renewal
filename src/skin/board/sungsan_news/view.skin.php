    ...
    <div class="ss-container">
        ...
        <div class="ss-panel">
            <?php if ($can_read) { ?>
                    ...
                    <section style="margin-top:32px">
                        ...
                        <?php for ($i = 0; $i < $view['file']['count']; $i++) { ?>
                            <?php if (!empty($view['file'][$i]['source'])) { ?>
                                <a class="ss-post-row" href="<?php echo $view['file'][$i]['href']; ?>">
                                    <p class="ss-post-title">📎 <?php echo $view['file'][$i]['source']; ?></p>
                                </a>
                            <?php } ?>
                        <?php } ?>
                        </div>
                ...
                <?php } ?>
            <?php } else { ?>
                <p>이 글은 <?php echo sungsan_get_visibility_label($visibility); ?> 공개 글입니다. 로그인 후 확인해 주세요.</p>
