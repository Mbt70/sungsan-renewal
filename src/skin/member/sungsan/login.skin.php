    ...
    <div class="mbskin_box">
        ...
        <form name="flogin" action="<?php echo get_text($login_action_url); ?>" onsubmit="return flogin_submit(this);" method="post">
            ...
            <fieldset id="login_fs">
                ...
                <input type="text" name="mb_id" id="login_id" required class="frm_input required" size="20" maxlength="20" autocomplete="username">

                <label for="login_pw">비밀번호 <strong>필수</strong></label>
                <input type="password" name="mb_password" id="login_pw" required class="frm_input required" size="20" maxlength="20" autocomplete="current-password">
