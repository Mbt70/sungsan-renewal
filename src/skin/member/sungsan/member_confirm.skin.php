...
<div id="mb_confirm" class="mbskin">
    ...
    <fieldset>
        ...
        <input type="password" name="mb_password" id="confirm_mb_password" required class="required frm_input" size="15" maxLength="20" aria-describedby="member_confirm_help" placeholder="비밀번호">
