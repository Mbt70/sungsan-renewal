...
<div id="find_info" class="new_win<?php if($config['cf_cert_use'] != 0 && $config['cf_cert_find'] != 0) { ?> cert<?php } ?>">
    <div class="new_win_con">
        ...
        <form name="fpasswordlost" action="<?php echo get_text($action_url); ?>" onsubmit="return fpasswordlost_submit(this);" method="post" autocomplete="off">
        ...
        <fieldset id="info_fs">
            ...
            <input type="email" name="mb_email" id="mb_email" required class="required frm_input full_input email" size="30" autocomplete="email" aria-describedby="password_lost_email_help">
        </fieldset>
