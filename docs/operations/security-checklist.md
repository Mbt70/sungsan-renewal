...
- `formmail_send.php` 폼메일 첨부 `file1/file2`도 PHP, PHP7/PHP8, HTML, JS, SVG 계열 첨부, `shell.php7`, `shell.php8`, `shell.php.jpg` 같은 실행형 또는 다중 확장자 파일, `.htaccess`, `.user.ini`가 전송 전에 차단되는지 확인합니다.
