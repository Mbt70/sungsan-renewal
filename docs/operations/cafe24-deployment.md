...
10. 관리자에서 `news` 게시판의 `bo_category_list`가 `공지|행사|자료|규정|활동소식` 기본값 또는 운영자가 정한 소식 종류 목록으로 저장되어 있는지 확인합니다. 소식 종류를 바꾸면 작성/목록 화면의 종류 선택과 필터, 홈 요약 링크의 최근 공지/다가오는 일정/자료와 규정/활동소식 보기 경로가 함께 바뀌어야 합니다.
